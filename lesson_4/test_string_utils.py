...
def test_capitalize_positive(string_utils, input_str, expected_output):
...
def test_capitalize_negative(string_utils, input_str, expected_output):
    assert string_utils.capitilize(input_str) == expected_output
...
def test_trim_positive(string_utils, input_str, expected_output):
...
def test_trim_negative(string_utils, input_str, expected_output):
    assert string_utils.trim(input_str) == expected_output
...
def test_to_list_positive(string_utils, input_str, expected_output):
    assert string_utils.to_list(input_str) == expected_output

@pytest.mark.parametrize("input_str, delimiter, expected_output", [
    ("a,b,c", ";", ["a,b,c"]),
])
def test_to_list_negative(string_utils, input_str, delimiter, expected_output):
